...
async def main():
    ...
    async with async_playwright() as p:
        ...
        print("Acessando a página inicial em PRODUÇÃO...")
        await page.goto("https://ahut-ecosystem.apexfyhub.com.br/rh/", wait_until="domcontentloaded", timeout=60000)
        ...
        while True:
            try:
                ...
                if valid_buttons:
                    ...
                    print(f"[{header_text}] Robô respondeu: {text[:30].strip()}...")
                ...
                if "Target page, context or browser has been closed" in str(e) or "Target closed" in str(e):
                    print("\nNavegador encerrado pelo usuário ou finalização do teste.")
                    break
                await asyncio.sleep(0.3)
