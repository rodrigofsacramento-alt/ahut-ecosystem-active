...
const logisticaModules = [
  {
    name: 'Parceiros Frete',
    description: 'Gestão de parceiros, transportadoras e fretes.',
    icon: Truck,
    href: '/freight',
  ...
  return (
    <div className="flex min-h-screen bg-slate-50 font-sans">
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden sidebar-offset">
        <TopBar title="Setor de Logística" />
          ...
          <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <div className="size-12 rounded-2xl bg-orange-600 text-white flex items-center justify-center shadow-lg shadow-orange-600/20">
                  <Package size={24} />
                </div>
                <div>
                  <h2 className="text-2xl sm:text-3xl font-black tracking-tight text-slate-900">Logística</h2>
