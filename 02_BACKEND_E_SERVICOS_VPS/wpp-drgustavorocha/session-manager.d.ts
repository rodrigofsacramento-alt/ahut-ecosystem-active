...
export declare function registerSessionFailure(sessionKey: string): void;
export declare function resetSessionBackoff(sessionKey: string): void;
export declare function isSessionInBackoff(sessionKey: string): {
    inBackoff: boolean;
    waitSec: number;
    failures: number;
};
